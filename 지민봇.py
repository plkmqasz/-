...
async def on_message(message):
    ...
    if message.content.startswith('!오늘게임'):
        randomNum = random.randrange(1, 3)
        if randomNum==1:
            await client.send_message(message.channel, embed=discord.Embed(title="게임각입니다.", color=discord.Color.blue()))
        else:
            await client.send_message(message.channel, embed=discord.Embed(title="자러갑시다....", color=discord.Color.red()))
        else:
            await client.send_message(message.channel, embed=discord.Embed(title="공부합시다....", color=discord.Color.red()))    
...
client.run('NzYwNDAxMjMyOTQ2Mzk3MTk1.X3Lg1Q.RUzTDwcRvF11CrADeNNgh2Jgc90')
